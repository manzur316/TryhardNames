...
const gameData = {
  ...
  valorant: {
    ...
    sections: {
      ...
      short: "Short competitive gamer tags for Valorant are the standard for high-level play. When you're executing a site take or calling out enemy positions, communication must be instant. A 3 or 4-letter name ensures your teammates can address you quickly without stumbling over syllables. Names like 'TenZ', 'Yay', or 'Asuna' set the template. Because of the Riot ID system, you can easily secure a short name like 'Aim' or 'Tap' as long as your tagline is unique. These short tags are the ultimate sign of a confident, competitive player.",
