...
| RM-24 | Launch Readiness | this PR | this GH PR | pending | Production smoke, observability, rollback, policy review, launch go/no-go, launch readiness tests. | No deploy execution, runtime scope, provider activation, `/cosmetics`, payments, migrations, env vars, or secrets. | RM-25 |
| RM-25 | Provider Expansion Readiness Matrix | next | none | none | Compare provider candidates using readiness-before-runtime policy. | No provider runtime. | RM-26 |
