...
| RM-25 | Provider Expansion Readiness Matrix | this PR | this GH PR | pending | Compare Riot, osu!, Steam, Supercell/Clash, Discord, and future console/Epic candidates using readiness-before-runtime policy; recommend RM-26 osu! Readiness Pack. | No provider runtime, OAuth, callbacks, tokens, env vars, `/cosmetics`, store/payments, migrations, or remote service changes. | RM-26 |
| RM-26 | osu! Readiness Pack | next | none | none | Official docs review, OAuth/API model review, proof/public projection design, trust/safety review. | No osu! runtime, tokens, callback route, env vars, or secrets. | RM-27 |
