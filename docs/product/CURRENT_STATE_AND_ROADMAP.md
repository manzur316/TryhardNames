...
- Production osu! public profile trust-safety QA and owner go/no-go.
...
| RM-33 | osu! Public Projection Smoke / Projection QA | This PR. Enables safe local public projection smoke only through allowlisted fields and full policy checks. |
| RM-34 | osu! Public Profile Trust-Safety QA | Next. Validates trust-safety behavior before production go/no-go. |
