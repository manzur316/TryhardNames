...
| RM-34 | osu! Public Profile Trust-Safety QA | This PR. Audits trust-safety, fixes the public renderer/mapper for osu! allowlisted DTOs, and keeps production blocked. |
| RM-35 | osu! Production Readiness / Staging Go-No-Go | Next. Produces staging/prod readiness evidence before any production enablement. |
