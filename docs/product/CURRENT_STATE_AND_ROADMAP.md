...
- Owner proof visibility controls for osu!.
...
| RM-31 | osu! Private Proof Publish Policy / Public Projection Gate | This PR. Defines and enforces a closed public projection gate for osu! proof data; public osu! projection remains blocked until owner visibility controls exist. |
| RM-32 | osu! Owner Proof Visibility Controls | Next. Adds explicit owner controls for proof visibility before any osu! public projection can be considered. |
