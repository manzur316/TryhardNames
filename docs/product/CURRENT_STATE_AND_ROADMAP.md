...
- RM-32 osu! Owner Proof Visibility Controls exists as owner-only private `/account` UI plus backend API mutation for private/public proof visibility preference, with public projection still gated.
...
- Public osu! projection smoke evidence after owner visibility preference.
...
| RM-32 | osu! Owner Proof Visibility Controls | This PR. Adds explicit owner controls for proof visibility preference while public projection remains blocked by allowlist. |
| RM-33 | osu! Public Projection Smoke / Projection QA | Next. Validates public projection after owner controls, published Passport, consent, allowlist, blocked field checks, and trust-safety gates. |
